...
static IniLine    *ini_file_create_string (IniSection *section, gchar *key, gchar *value);
...
static IniSection *
ini_file_create_section(IniFile* ini, gchar *name)
{
  IniSection *section;
...
static IniLine *
ini_file_create_string(IniSection *section, gchar *key, gchar *value)
{
  IniLine *line;
...
static IniSection *
ini_file_find_section( IniFile *ini, gchar *name)
{
  IniSection *section;
  GList *list;
  list = ini->sections;
...
IniFile *
ini_file_open_file(gchar *filename)
{
  IniFile *ini;
  FILE *file;
...
gboolean
ini_file_write_file(IniFile *ini, gchar *filename)
{
  FILE *file;
  ...
  fprintf(file,_("# DO NOT Modify this file by hand unless you exactly know what you are doing.\n"));
...
gboolean
ini_file_read_string(IniFile *ini, gchar *section, gchar *key, gchar **value)
{
  IniSection *sect;
  IniLine *line;
  *value = NULL;
...
gboolean
ini_file_read_int(IniFile *ini, gchar *section, gchar *key, gint *value)
{
  gchar *str;
...
gboolean
ini_file_read_boolean(IniFile *ini, gchar *section, gchar *key, gboolean *value)
{
  gchar *str;
  if(!ini_file_read_string(ini,section,key,&str))
  {
...
void
ini_file_write_int(IniFile *ini, gchar *section, gchar *key, gint value)
{
	gchar *strvalue;
...
void
ini_file_write_boolean(IniFile *ini, gchar *section, gchar *key, gboolean value)
{
	if(value)
...
gboolean
ini_file_rename_section(IniFile *ini, gchar *section, gchar *section_name)
{
	IniSection *sect;
	sect = ini_file_find_section(ini,section);
	if(sect)
