...
static GdkPixmap *ui_double_pixmap =
    NULL; /* Background pixmap of the Drawing srea */
...
void get_main_menu(GtkWidget *window, GtkWidget **menubar) {
  ...
  *menubar = gtk_menu_bar_new();
  ...
  gtk_widget_add_accelerator(menuitem, "activate", accel_group, GDK_F1, 0,
                             GTK_ACCEL_VISIBLE);
  g_signal_connect(G_OBJECT(menuitem), "activate", G_CALLBACK(ui_game_begin),
                   (gpointer)1);
  menuitem = gtk_menu_item_new_with_mnemonic(_("_Normal"));
  gtk_menu_shell_append(GTK_MENU_SHELL(menu2), menuitem);
  gtk_widget_add_accelerator(menuitem, "activate", accel_group, GDK_F2, 0,
                             GTK_ACCEL_VISIBLE);
  g_signal_connect(G_OBJECT(menuitem), "activate", G_CALLBACK(ui_game_begin),
                   (gpointer)2);
  menuitem = gtk_menu_item_new_with_mnemonic(_("_Hard"));
  gtk_menu_shell_append(GTK_MENU_SHELL(menu2), menuitem);
  gtk_widget_add_accelerator(menuitem, "activate", accel_group, GDK_F3, 0,
                             GTK_ACCEL_VISIBLE);
  g_signal_connect(G_OBJECT(menuitem), "activate", G_CALLBACK(ui_game_begin),
                   (gpointer)3);
  ...
  gtk_menu_shell_append(GTK_MENU_SHELL(menu2), menuitem);
  gtk_widget_add_accelerator(menuitem, "activate", accel_group, GDK_F4, 0,
                             GTK_ACCEL_VISIBLE);
  g_signal_connect(G_OBJECT(menuitem), "activate", G_CALLBACK(ui_game_begin),
                   (gpointer)4);
  ...
  menuitem = gtk_menu_item_new_with_mnemonic(_("_Easy"));
  gtk_menu_shell_append(GTK_MENU_SHELL(menu2), menuitem);
  g_signal_connect(G_OBJECT(menuitem), "activate", G_CALLBACK(print_hello),
                   (gpointer)1);
  menuitem = gtk_menu_item_new_with_mnemonic(_("_Normal"));
  gtk_menu_shell_append(GTK_MENU_SHELL(menu2), menuitem);
  g_signal_connect(G_OBJECT(menuitem), "activate", G_CALLBACK(print_hello),
  ...
  gtk_menu_shell_append(GTK_MENU_SHELL(menu1), menuitem);
  gtk_widget_add_accelerator(menuitem, "activate", accel_group, GDK_F12, 0,
                             GTK_ACCEL_VISIBLE);
  g_signal_connect(G_OBJECT(menuitem), "activate", G_CALLBACK(ui_game_giveup),
                   (gpointer)0);
  menuitem = gtk_separator_menu_item_new();
  gtk_menu_shell_append(GTK_MENU_SHELL(menu1), menuitem);
  menuitem = gtk_image_menu_item_new_from_stock(GTK_STOCK_QUIT, accel_group);
  gtk_menu_shell_append(GTK_MENU_SHELL(menu1), menuitem);
  g_signal_connect(G_OBJECT(menuitem), "activate", G_CALLBACK(gtk_main_quit),
                   (gpointer)0);
  ...
  gtk_menu_shell_append(GTK_MENU_SHELL(menu1), menuitem);
  gtk_widget_add_accelerator(menuitem, "activate", accel_group, GDK_F5, 0,
                             GTK_ACCEL_VISIBLE);
  g_signal_connect(G_OBJECT(menuitem), "activate", G_CALLBACK(ui_game_hint),
                   (gpointer)0);
  menuitem = gtk_menu_item_new_with_mnemonic(_("_Shuffle"));
  gtk_menu_shell_append(GTK_MENU_SHELL(menu1), menuitem);
  gtk_widget_add_accelerator(menuitem, "activate", accel_group, GDK_F6, 0,
                             GTK_ACCEL_VISIBLE);
  g_signal_connect(G_OBJECT(menuitem), "activate", G_CALLBACK(ui_game_shuffle),
                   (gpointer)0);
  menuitem = gtk_menu_item_new_with_mnemonic(_("_Pause/Proceed"));
  gtk_menu_shell_append(GTK_MENU_SHELL(menu1), menuitem);
  gtk_widget_add_accelerator(menuitem, "activate", accel_group, GDK_F7, 0,
                             GTK_ACCEL_VISIBLE);
  g_signal_connect(G_OBJECT(menuitem), "activate", G_CALLBACK(ui_game_pause),
                   (gpointer)0);
  menuitem = gtk_separator_menu_item_new();
  gtk_menu_shell_append(GTK_MENU_SHELL(menu1), menuitem);
  menuitem = gtk_menu_item_new_with_mnemonic(_("H_ide"));
  gtk_menu_shell_append(GTK_MENU_SHELL(menu1), menuitem);
  gtk_widget_add_accelerator(menuitem, "activate", accel_group, GDK_Escape, 0,
                             GTK_ACCEL_VISIBLE);
  /*
  ...
  gtk_menu_shell_append(GTK_MENU_SHELL(menu1), menuitem);
  g_signal_connect(G_OBJECT(menuitem), "activate", G_CALLBACK(ui_theme_editor),
                   (gpointer)0);
  rootmenu = gtk_menu_item_new_with_mnemonic(_("_Functions"));
  gtk_menu_item_set_submenu(GTK_MENU_ITEM(rootmenu), menu1);
  gtk_menu_shell_append(GTK_MENU_SHELL(*menubar), rootmenu);
  g_signal_connect(G_OBJECT(menu1), "show", G_CALLBACK(ui_functions_on_show),
                   NULL);
  /*============================================================*/
  menu1 = gtk_menu_new();
  ...
  ui_menu_item.background_music =
      GTK_CHECK_MENU_ITEM(gtk_check_menu_item_new_with_mnemonic(_("_Music")));
  gtk_menu_shell_append(GTK_MENU_SHELL(menu1),
                        GTK_WIDGET(ui_menu_item.background_music));
  g_signal_connect(G_OBJECT(ui_menu_item.background_music), "activate",
                   G_CALLBACK(ui_use_m_s_bg), (gpointer)0);
  ui_menu_item.sound_effect =
      GTK_CHECK_MENU_ITEM(gtk_check_menu_item_new_with_mnemonic(_("_Sound")));
  gtk_menu_shell_append(GTK_MENU_SHELL(menu1),
                        GTK_WIDGET(ui_menu_item.sound_effect));
  g_signal_connect(G_OBJECT(ui_menu_item.sound_effect), "activate",
                   G_CALLBACK(ui_use_m_s_bg), (gpointer)1);
  ui_menu_item.background_picture = GTK_CHECK_MENU_ITEM(
      gtk_check_menu_item_new_with_mnemonic(_("_Background Picture")));
  gtk_menu_shell_append(GTK_MENU_SHELL(menu1),
                        GTK_WIDGET(ui_menu_item.background_picture));
  g_signal_connect(G_OBJECT(ui_menu_item.background_picture), "activate",
                   G_CALLBACK(ui_use_m_s_bg), (gpointer)2);
  menuitem = gtk_separator_menu_item_new();
  gtk_menu_shell_append(GTK_MENU_SHELL(menu1), menuitem);
  menuitem = gtk_menu_item_new_with_mnemonic(_("_Cheat"));
  gtk_menu_shell_append(GTK_MENU_SHELL(menu1), menuitem);
  gtk_widget_add_accelerator(menuitem, "activate", accel_group, GDK_F8, 0,
                             GTK_ACCEL_VISIBLE);
  g_signal_connect(G_OBJECT(menuitem), "activate", G_CALLBACK(ui_game_cheat),
                   (gpointer)0);
  rootmenu = gtk_menu_item_new_with_mnemonic(_("_Setting"));
  gtk_menu_item_set_submenu(GTK_MENU_ITEM(rootmenu), menu1);
  gtk_menu_shell_append(GTK_MENU_SHELL(*menubar), rootmenu);
  g_signal_connect(G_OBJECT(menu1), "show", G_CALLBACK(ui_setting_on_show),
                   NULL);
  /*============================================================*/
  menu1 = gtk_menu_new();
  menuitem = gtk_menu_item_new_with_mnemonic(_("_View Scores"));
  gtk_menu_shell_append(GTK_MENU_SHELL(menu1), menuitem);
  gtk_widget_add_accelerator(menuitem, "activate", accel_group, GDK_F9, 0,
                             GTK_ACCEL_VISIBLE);
  g_signal_connect(G_OBJECT(menuitem), "activate", G_CALLBACK(ui_view_score),
                   (gpointer)0);
  ...
  gtk_menu_shell_append(GTK_MENU_SHELL(menu1), menuitem);
  g_signal_connect(G_OBJECT(menuitem), "activate", G_CALLBACK(ui_rule),
                   (gpointer)0);
  menuitem = gtk_menu_item_new_with_mnemonic(_("_Author"));
  gtk_menu_shell_append(GTK_MENU_SHELL(menu1), menuitem);
  g_signal_connect(G_OBJECT(menuitem), "activate", G_CALLBACK(ui_about),
                   (gpointer)0);
 ...
 */
void ui_game_on_show(GtkWidget *w, gpointer data) {
 ...
 */
void ui_functions_on_show(GtkWidget *w, gpointer data) {
  gtk_widget_set_sensitive(g_list_nth_data(GTK_MENU(w)->menu_shell.children, 0),
 ...
 */
void ui_setting_on_show(GtkWidget *w, gpointer data) {
...
gboolean ui_replace_image(GdkPoint p1, GdkPoint p2) {
  ...
  /*according to data in algorithm_game and the selected position, redraw the
    image at (i,j) this function is modified from ui_game_begin function
    //(algorithm_game.data[p1.x][p1.y] - 1)
  */
  /* Draw card back image */
  gdk_pixbuf_render_to_drawable_alpha(
      ui_pixbuf.cardbacks, ui_double_pixmap, 0,
      (ui_pixbuf.cardback_choice >= 5 ? 1 : ui_pixbuf.cardback_choice + 1) *
          UI_BACK_HEIGHT,
      UI_FIXED_START_DRAW_LEFT + (p1.y - algorithm_game.difficulty) *
                                     (UI_BACK_WIDTH - UI_BACK_BORDER_1),
      ...
      GDK_PIXBUF_ALPHA_BILEVEL, 128, GDK_RGB_DITHER_NORMAL, 0, 0);
  /*gdk_draw_rectangle (ui_double_pixmap,
                      ui_drawingarea->style->black_gc,
                      TRUE,
                                          UI_FIXED_START_DRAW_LEFT + (p1.y -
     algorithm_game.difficulty)*(UI_BACK_WIDTH-UI_BACK_BORDER_1),
                                  UI_FIXED_START_DRAW_TOP + p1.x*(UI_BACK_HEIGHT
     - UI_BACK_BORDER_2),
                                          UI_BACK_WIDTH-UI_BACK_BORDER_1,UI_BACK_HEIGHT-UI_BACK_BORDER_2);*/
  /* Draw card's front image */
  gdk_pixbuf_render_to_drawable_alpha(
      ui_pixbuf.cardimages, ui_double_pixmap,
      (algorithm_game.data[p1.x][p1.y] - 1) * UI_IMAGE_SIZE, 0,
      UI_FIXED_START_DRAW_LEFT +
          (p1.y - algorithm_game.difficulty) *
              (UI_BACK_WIDTH - UI_BACK_BORDER_1) +
          (UI_BACK_WIDTH - UI_BACK_BORDER_1 - UI_IMAGE_SIZE) / 2,
      UI_FIXED_START_DRAW_TOP + p1.x * (UI_BACK_HEIGHT - UI_BACK_BORDER_2) +
          (UI_BACK_HEIGHT - UI_BACK_BORDER_2 - UI_IMAGE_SIZE) / 2,
      UI_IMAGE_SIZE, UI_IMAGE_SIZE, GDK_PIXBUF_ALPHA_BILEVEL, 128,
      GDK_RGB_DITHER_NORMAL, 0, 0);
  update_rect.x =
      UI_FIXED_START_DRAW_LEFT +
      (p1.y - algorithm_game.difficulty) * (UI_BACK_WIDTH - UI_BACK_BORDER_1);
  update_rect.y =
      UI_FIXED_START_DRAW_TOP + p1.x * (UI_BACK_HEIGHT - UI_BACK_BORDER_2);
  ...
  if (p2.x != -1 && p2.y != -1) {
    ...
    gdk_pixbuf_render_to_drawable_alpha(
        ...
        (ui_pixbuf.cardback_choice >= 5 ? 1 : ui_pixbuf.cardback_choice + 1) *
            UI_BACK_HEIGHT,
        UI_FIXED_START_DRAW_LEFT + (p2.y - algorithm_game.difficulty) *
                                       (UI_BACK_WIDTH - UI_BACK_BORDER_1),
    ...
    /*gdk_draw_rectangle (ui_double_pixmap,
                      ui_drawingarea->style->black_gc,
                      TRUE,
                                          UI_FIXED_START_DRAW_LEFT + (p2.y -
       algorithm_game.difficulty)*(UI_BACK_WIDTH-UI_BACK_BORDER_1),
                                  UI_FIXED_START_DRAW_TOP + p2.x*(UI_BACK_HEIGHT
       - UI_BACK_BORDER_2),
                                          UI_BACK_WIDTH-UI_BACK_BORDER_1,UI_BACK_HEIGHT-UI_BACK_BORDER_2);*/
    /* Draw card's front image */
    gdk_pixbuf_render_to_drawable_alpha(
        ...
        UI_FIXED_START_DRAW_LEFT +
            (p2.y - algorithm_game.difficulty) *
                (UI_BACK_WIDTH - UI_BACK_BORDER_1) +
            (UI_BACK_WIDTH - UI_BACK_BORDER_1 - UI_IMAGE_SIZE) / 2,
        UI_FIXED_START_DRAW_TOP + p2.x * (UI_BACK_HEIGHT - UI_BACK_BORDER_2) +
            (UI_BACK_HEIGHT - UI_BACK_BORDER_2 - UI_IMAGE_SIZE) / 2,
    ...
    update_rect.x =
        UI_FIXED_START_DRAW_LEFT +
        (p2.y - algorithm_game.difficulty) * (UI_BACK_WIDTH - UI_BACK_BORDER_1);
    update_rect.y =
        UI_FIXED_START_DRAW_TOP + p2.x * (UI_BACK_HEIGHT - UI_BACK_BORDER_2);
    update_rect.width = UI_BACK_WIDTH - UI_BACK_BORDER_1;
    update_rect.height = UI_BACK_HEIGHT - UI_BACK_BORDER_2;
...
gboolean ui_redraw_images(void) {
  ...
  /*according to the data in the algorithm_game,and selected position, redraw
    all card images modified from ui_game_begin function*/
  for (i = 0; i < algorithm_game.row; i++) {
    for (j = 0; j < algorithm_game.col; j++) {
      if (algorithm_game.data[i][j] > 0) {
        ...
        gdk_pixbuf_render_to_drawable_alpha(
            ui_pixbuf.cardbacks, ui_double_pixmap, 0,
            ui_pixbuf.cardback_choice * UI_BACK_HEIGHT,
            UI_FIXED_START_DRAW_LEFT + (j - algorithm_game.difficulty) *
                                           (UI_BACK_WIDTH - UI_BACK_BORDER_1),
            UI_FIXED_START_DRAW_TOP + i * (UI_BACK_HEIGHT - UI_BACK_BORDER_2),
            UI_BACK_WIDTH, UI_BACK_HEIGHT, GDK_PIXBUF_ALPHA_BILEVEL, 128,
            GDK_RGB_DITHER_NORMAL, 0, 0);
        /* Draw card's front image */
        gdk_pixbuf_render_to_drawable_alpha(
            ui_pixbuf.cardimages, ui_double_pixmap,
...
*/
gboolean ui_drawingarea_clicked(GtkWidget *window, GdkEventButton *event) {
  if (algorithm_game.status == ALGORITHM_GAME_RUN) {
    if (event->type == GDK_BUTTON_PRESS && event->button != 2) {
      gint i, j;
      if (event->button == 1) /*Mouse, Left button*/
      {
        if (event->x > UI_FIXED_START_DRAW_LEFT -
                           algorithm_game.difficulty *
                               (UI_BACK_WIDTH - UI_BACK_BORDER_1) &&
            event->x < UI_FIXED_START_DRAW_LEFT +
                           (algorithm_game.col - algorithm_game.difficulty) *
                               (UI_BACK_WIDTH - UI_BACK_BORDER_1))
          if (event->y > UI_FIXED_START_DRAW_TOP &&
              event->y < UI_FIXED_START_DRAW_TOP +
                             algorithm_game.row *
                                 (UI_BACK_HEIGHT - UI_BACK_BORDER_2)) {
            j = (event->x - UI_FIXED_START_DRAW_LEFT +
                 algorithm_game.difficulty *
                     (UI_BACK_WIDTH - UI_BACK_BORDER_1)) /
                (UI_BACK_WIDTH - UI_BACK_BORDER_1);
            i = (event->y - UI_FIXED_START_DRAW_TOP) /
                (UI_BACK_HEIGHT - UI_BACK_BORDER_2);
            /*g_print("i: %d, j: %d\n",i,j);*/
            if (algorithm_game.data[i][j] == 0) {
              return FALSE;
            ...
            if (ui_point1.x > -1) /*there is a selected card already*/
            {
              if (ui_point1.x != i || ui_point1.y != j) {
                ui_point2.x = i;
                ui_point2.y = j;
                /*look if the two selected card could be linked or not, if
                   yes,delete them,if no,cancel the selected status*/
                if (algorithm_can_link(ui_point1, ui_point2, NULL, NULL)) {
                  ...
                  /*algorithm_link,must be puted after ui_link function, because
                    ui_link need to judge the link path,and before this,the data
                    must not be modified*/
                  progress_timeout(GINT_TO_POINTER(
                      1)); /*add 1 second after every link action*/
                  ...
                  if (gtk_check_menu_item_get_active(
                    ...
                    ret =
                        pthread_create(&id, &attr, (void *)ui_play, "Link.wav");
                    if (ret != 0) {
                  ...
                  */
                  ...
                  if (gtk_check_menu_item_get_active(
                    ...
                    pthread_attr_init(&attr);
                    pthread_attr_setdetachstate(&attr, PTHREAD_CREATE_DETACHED);
                    ret = pthread_create(&id, &attr, (void *)ui_play,
                                         "CanntLink.wav");
                    if (ret != 0) {
                      g_print(_("Create pthread error!\n"));
                      exit(1);
              ...
              } else /*click the card that has already been selected,so cancel
                        the selected status*/
              {
                ui_point1.x = -1;
                ui_point1.y = -1;
                ...
                if (gtk_check_menu_item_get_active(ui_menu_item.sound_effect)) {
                  ...
                  pthread_attr_setdetachstate(&attr, PTHREAD_CREATE_DETACHED);
                  ret =
                      pthread_create(&id, &attr, (void *)ui_play, "Cancle.wav");
                  if (ret != 0) {
                    g_print(_("Create pthread error!\n"));
                    exit(1);
                  }
...
void ui_drawingarea_draw_bg(gint choice) {
  ...
  /* Empty all images */
  gdk_drawable_get_size(GDK_DRAWABLE(ui_double_pixmap), &pixmap_width,
                        &pixmap_height);
  gdk_draw_rectangle(ui_double_pixmap, ui_drawingarea->style->black_gc, TRUE, 0,
                     0, pixmap_width, pixmap_height);
  if (choice == 0) /* ui_game_init call this function, draw mainback*/
  {
    ...
    gdk_pixbuf_render_to_drawable_alpha(
        ui_pixbuf.mainback, ui_double_pixmap, 0, 0, (pixmap_width - width) / 2,
        (pixmap_height - height) / 2, width, height, GDK_PIXBUF_ALPHA_BILEVEL,
  ...
  if (ui_pixbuf.randomback_choice == 0) {
    ...
    gdk_pixbuf_render_to_drawable_alpha(
        ui_pixbuf.randomback, ui_double_pixmap, 0, 0,
        (pixmap_width - width) / 2, (pixmap_height - height) / 2, width, height,
        GDK_PIXBUF_ALPHA_BILEVEL, 128, GDK_RGB_DITHER_NORMAL, 0, 0);
  }
}
...
/*
  ...
  data: stand for game diffictulty, but it is based on 1,and the game difficulty
  is based on 0,BE CARE!!!
*/
void ui_game_begin(GtkWidget *w, gpointer data) {
  ...
  {
    /* Read difficulty info from ini file,judge if player can play this
     * difficulty. */
    ...
    if (GPOINTER_TO_INT(data) > current_diff) {
      ...
      case 2:
        message = g_strdup(
            _("You should pass difficulty Easy before you play Normal."));
        break;
      case 3:
        message = g_strdup(
            _("You should pass difficulty Normal before you play Hard."));
        break;
      }
      type = GTK_MESSAGE_WARNING;
      dialog = gtk_message_dialog_new(
          NULL, GTK_DIALOG_MODAL | GTK_DIALOG_DESTROY_WITH_PARENT, type,
  ...
  if (GPOINTER_TO_INT(data) == 4) {
    if (ui_read_game_data()) {
      ...
      } else { /* In order to load the paused game,do not add timer,so we return
                  here.*/
        algorithm_game.status = ALGORITHM_GAME_RUN;
        ui_game_pause();
        ui_refresh_top();
      ...
      GtkMessageType type;
      gchar *message = NULL;
      message = g_strdup(_("Read saved game data error,Maybe you have not "
                           "saved a game before.\n"));
      type = GTK_MESSAGE_WARNING;
      dialog = gtk_message_dialog_new(
          NULL, GTK_DIALOG_MODAL | GTK_DIALOG_DESTROY_WITH_PARENT, type,
    ...
    if (!algorithm_game_begin(
            data)) /*init the array and other related datas in the
                      algorith_game,ready for start the game.*/
    {
...
/*
  time_out function
  according to my test result,from the time_out call back function be called, to
  the call back function return, the clock is PAUSEED,that is to say,when the
  game is over,no matter how long you stay on the popup dialog window, the clock
  will not emerge another time out signal
*/
gboolean progress_timeout(gpointer pvalue) {
  ...
  if (value == 9999) { /*full fill the time*/
    ...
    if (value != 0) {
      time_remain += value;
      time_remain = time_remain > ui_get_time_limited() ? ui_get_time_limited()
                                                        : time_remain;
      gtk_progress_bar_set_fraction(
          GTK_PROGRESS_BAR(ui_top.progress_bar),
          ((double)time_remain / (double)ui_get_time_limited()));
      return TRUE;
    } else {
      if (time_remain > 0) {
        time_remain--;
...
void ui_game_giveup(GtkWidget *w, gpointer data) {
  ...
  /*giveup,do not record the score,so should not call ui_game_over function
   * here.*/
  if (algorithm_game.status != ALGORITHM_GAME_STOP) {
    ui_game_init();
  } else {
...
/*
  ...
  this difficulty,then over the game,waiting for player to choose another
  difficulty.
*/
void ui_game_next_level(void) {
  if (timer_handle != 0)
    gtk_timeout_remove(timer_handle); /* remove the timer */
  if (algorithm_game_net_level()) {   /*switch to the next level*/
    if (gtk_check_menu_item_get_active(ui_menu_item.sound_effect)) {
      pthread_t id;
      pthread_attr_t attr;
      int ret;
    ...
    ui_pixbuf.cardback_choice =
        ui_pixbuf.cardback_choice >= 5 ? 0 : ui_pixbuf.cardback_choice + 1;
    if (pak_info.back_num > 0) {
      ui_pixbuf.randomback_choice =
          ui_pixbuf.randomback_choice > pak_info.back_num - 1
              ? 1
              : ui_pixbuf.randomback_choice + 1;
      /* Extract the bg picture and read it to ui_pixbuf.randomback */
      gchar *bgfilename = NULL;
      bgfilename =
          g_strdup_printf("back%d.jpg", ui_pixbuf.randomback_choice - 1);
      if (!ExtractSingleFile(bgfilename)) {
        g_print(_("Failed to extract file:%s.\n"), bgfilename);
      }
      g_free(bgfilename);
      bgfilename = g_strdup_printf("/tmp/llk_back%d.jpg",
                                   ui_pixbuf.randomback_choice - 1);
      if (ui_pixbuf.randomback)
        g_object_unref(ui_pixbuf.randomback); /* Free old randomback pixbuf */
      ui_pixbuf.randomback = gdk_pixbuf_new_from_file(bgfilename, NULL);
      remove(bgfilename);
      g_free(bgfilename);
      if (ui_pixbuf.randomback == NULL) {
        ui_pixbuf.randomback = ui_pixbuf.mainback;
        g_print(_("randomback=NULL,Error occored.\n"));
      }
    } else {
...
void ui_game_shuffle(GtkWidget *w, gpointer data) {
  ...
  if (timer_handle != 0)
    gtk_timeout_remove(timer_handle); /*turn off the timer*/
  ...
  timer_handle =
      gtk_timeout_add(1000, progress_timeout, NULL); /*turn on the timer*/
}
...
void ui_game_over(gboolean success) {
  ...
  if (success) {
    ...
    case 0:
      message = g_strdup(_("Congratulations,you have success the Easy "
                           "difficulty,you may play Normal now!"));
      break;
    case 1:
      message = g_strdup(_("Congratulations,you have success the Normal "
                           "difficulty,you may play Hard now!"));
      break;
    case 2:
      message = g_strdup(_("Congratulations,you have success all the "
                           "difficulties,I admire you so much..."));
      break;
    }
    ini_file_write_int(ui_ini, "GAMERECORD", "difficulty",
...
/*
  ...
  the two cards which can link have already been deleted,so only change the
  position of these cards left.
*/
...
void ui_game_pause(void) {
  ...
  if (algorithm_game.status == ALGORITHM_GAME_RUN) {
    ...
    /*hide all the images on the drawingarea,then put a picture that stand for
     * the pause status*/
    gdk_draw_rectangle(ui_double_pixmap, ui_drawingarea->style->black_gc, TRUE,
                       0, 0, pixmap_width, pixmap_height);
    if (ui_pixbuf.pause) {
      width = gdk_pixbuf_get_width(ui_pixbuf.pause);
      height = gdk_pixbuf_get_height(ui_pixbuf.pause);
      gdk_pixbuf_render_to_drawable_alpha(
          ui_pixbuf.pause, ui_double_pixmap, 0, 0, (pixmap_width - width) / 2,
          (pixmap_height - height) / 2, width, height, GDK_PIXBUF_ALPHA_BILEVEL,
          128, GDK_RGB_DITHER_NORMAL, 0, 0);
    }
    update_rect.x = 0;
...
gint ui_get_time_limited(void) {
  if (algorithm_game.difficulty == 2)
    return 240;
  else
    return 200;
}
          ...
          for (l = 0; l < algorithm_game.col; l++) {
            ...
            if (algorithm_game.data[k][l] > 0) {
              ...
              if (algorithm_can_link(p1, p2, NULL, NULL)) {
                ui_replace_image(p1, p2); /*the window's redraw action is done
                                             in ui_replace_image function*/
                /*switch the card image at p1 and p2,the image stand for hint
                 * status*/
                if (gtk_check_menu_item_get_active(ui_menu_item.sound_effect)) {
                  pthread_t id;
                  pthread_attr_t attr;
...
*/
void ui_add_line(GdkPoint p1, GdkPoint p2, GSList **link_line) {
  gint i;
...
*/
void ui_draw_line(GSList *r_line) {
  /*  gint i;
    gint width,height;
      ...
      if(p1.y < p2.y)
        for(i=p1.y; i<p2.y; i++)
        {
          ...
          gdk_pixbuf_render_to_drawable_alpha(ui_pixbuf.horizon,ui_double_pixmap,
                  0,0,UI_FIXED_START_DRAW_LEFT+(i-algorithm_game.difficulty)*(UI_BACK_WIDTH-UI_BACK_BORDER_1)
    + 20, UI_FIXED_START_DRAW_TOP + p1.x*(UI_BACK_HEIGHT-UI_BACK_BORDER_2),
                  width,height,
    ...
    (i-algorithm_game.difficulty)*(UI_BACK_WIDTH-UI_BACK_BORDER_1)+20,
                  UI_FIXED_START_DRAW_TOP +
    p1.x*(UI_BACK_HEIGHT-UI_BACK_BORDER_2), width,height,
                  GDK_PIXBUF_ALPHA_BILEVEL,128,
                  GDK_RGB_DITHER_NORMAL, 0, 0);
        }
    }*/
  ...
  /*  {
      if(p1.x < p2.x)
        for(i=p1.x; i<p2.x; i++)
        {
          ...
          gdk_pixbuf_render_to_drawable_alpha(ui_pixbuf.vertical,ui_double_pixmap,
                  0,0,UI_FIXED_START_DRAW_LEFT +
    (p1.y-algorithm_game.difficulty)*(UI_BACK_WIDTH-UI_BACK_BORDER_1),
                  UI_FIXED_START_DRAW_TOP + i*(UI_BACK_HEIGHT -
    UI_BACK_BORDER_2) + 25, width,height, GDK_PIXBUF_ALPHA_BILEVEL,128,
                  GDK_RGB_DITHER_NORMAL, 0, 0);
        }
      else
        for(i=p2.x; i<p1.x; i++)
    ...
    (p1.y-algorithm_game.difficulty)*(UI_BACK_WIDTH-UI_BACK_BORDER_1),
                  UI_FIXED_START_DRAW_TOP + i*(UI_BACK_HEIGHT-UI_BACK_BORDER_2)
    + 25, width,height, GDK_PIXBUF_ALPHA_BILEVEL,128, GDK_RGB_DITHER_NORMAL, 0,
    0);
        }
    }*/
  ...
  */
  ...
  for (i = 0; i < g_slist_length(link_line); i++) {
    ...
    case 1:
      gdk_pixbuf_render_to_drawable_alpha(
          tmp_pixbuf, ui_double_pixmap, 0, 0,
          UI_FIXED_START_DRAW_LEFT +
              (tmp_point->y - algorithm_game.difficulty) *
                  (UI_BACK_WIDTH - UI_BACK_BORDER_1),
          UI_FIXED_START_DRAW_TOP +
              tmp_point->x * (UI_BACK_HEIGHT - UI_BACK_BORDER_2) - 25,
          width, height, GDK_PIXBUF_ALPHA_BILEVEL, 128, GDK_RGB_DITHER_NORMAL,
          0, 0);
      break;
    case 2:
      gdk_pixbuf_render_to_drawable_alpha(
    ...
    case 3:
      gdk_pixbuf_render_to_drawable_alpha(
          ...
          UI_FIXED_START_DRAW_LEFT +
              ...
              20,
          UI_FIXED_START_DRAW_TOP +
              tmp_point->x * (UI_BACK_HEIGHT - UI_BACK_BORDER_2),
          width, height, GDK_PIXBUF_ALPHA_BILEVEL, 128, GDK_RGB_DITHER_NORMAL,
          0, 0);
      break;
    case 4:
...
static gint configure_event(GtkWidget *widget, GdkEventConfigure *event) {
  ...
  ui_double_pixmap = gdk_pixmap_new(widget->window, widget->allocation.width,
                                    widget->allocation.height, -1);
  gdk_draw_rectangle(ui_double_pixmap, widget->style->black_gc, TRUE, 0, 0,
...
static gint expose_event(GtkWidget *widget, GdkEventExpose *event) {
  gdk_draw_pixmap(widget->window,
                  ...
                  ui_double_pixmap, event->area.x, event->area.y, event->area.x,
...
gboolean ui_load_ini_pak(gchar **message) {
  ...
  *message = NULL;
  ...
  if (result == -1) {
    ...
    {
      *message = g_strdup(_("User Setting Save Error,fail to creat "
                            "directory:$HOME/.llk_linux\n"));
      return FALSE;
    }
  }
  path = g_strdup_printf("%s/UserSettings.ini",
                         path); /* path = $HOME/.llk_linux/UserSettings.ini */
  while (1) {
    if (g_file_test(path, G_FILE_TEST_EXISTS)) {
      ...
      if (ui_ini == NULL) {
        *message = g_strdup(_("Unable to read UserSettings.ini"));
        ...
        if (tmp)
          gtk_check_menu_item_set_active(ui_menu_item.background_music, TRUE);
        else
          gtk_check_menu_item_set_active(ui_menu_item.background_music, FALSE);
        ini_file_read_boolean(ui_ini, "UISETTING", "sound", &tmp);
        if (tmp)
          gtk_check_menu_item_set_active(ui_menu_item.sound_effect, TRUE);
        else
          gtk_check_menu_item_set_active(ui_menu_item.sound_effect, FALSE);
        ini_file_read_boolean(ui_ini, "UISETTING", "bgpicture", &tmp);
        if (tmp)
          gtk_check_menu_item_set_active(ui_menu_item.background_picture, TRUE);
        else
          gtk_check_menu_item_set_active(ui_menu_item.background_picture,
                                         FALSE);
        ...
        if (!ini_file_read_string(ui_ini, "UISETTING", "themenum",
                                  &return_str)) {
          *message =
              g_strdup(_("Failed to read \"[UISETTING]/themename\" key."));
          return FALSE;
        }
        themename = (gchar *)g_malloc(sizeof(gchar) * 30);
        themenum = (gchar *)g_malloc(sizeof(gchar) *
                                     10); /* "Theme10" string length = 8 */
        for (i = 0; i < 10; i++) {
          ...
          if (!strcmp(themename, ""))
            continue;
          menuitem =
              gtk_radio_menu_item_new_with_label(radio_item_group, themename);
          radio_item_group =
          ...
          gtk_signal_connect(GTK_OBJECT(menuitem), "activate",
                             GTK_SIGNAL_FUNC(radio_item_on_clicked),
                             GINT_TO_POINTER(i));
      ...
      if (!ini_file_write_file(ui_ini, path)) {
        *message =
            g_strdup(_("Unable to save $HOME/.llk_linux/UserSettings.ini"));
        return FALSE;
      }
  ...
  if (!g_file_test(path, G_FILE_TEST_EXISTS)) {
    *message = g_strdup_printf(
        _("The package file:LLK_DATA_PATH/pak/%s does not exists."),
        return_str);
    g_free(return_str);
    return FALSE;
  }
  ...
  if (!ExtractSingleFile("cardimages.png") ||
      !ExtractSingleFile("cardbacks.png") ||
      !ExtractSingleFile("horizon.png") || !ExtractSingleFile("vertical.png") ||
      !ExtractSingleFile("pause.jpg") || !ExtractSingleFile("logo.png") ||
      !ExtractSingleFile("mainback.jpg")) {
    *message = g_strdup(_("Failed to extract necessary jpg/png files."));
    return FALSE;
  }
  ui_pixbuf.cardimages =
      gdk_pixbuf_new_from_file("/tmp/llk_cardimages.png", NULL);
  ui_pixbuf.cardbacks =
      gdk_pixbuf_new_from_file("/tmp/llk_cardbacks.png", NULL);
  ...
  ui_pixbuf.cardback_choice =
      g_rand_int_range(ui_rand, 0, 6); /*begin to end-1*/
  if (pak_info.back_num > 0) {
    ui_pixbuf.randomback_choice =
        g_rand_int_range(ui_rand, 1, pak_info.back_num + 1);
    /* Extract the bg picture and read it to ui_pixbuf.randomback */
    gchar *bgfilename = NULL;
    ...
    g_free(bgfilename);
    bgfilename =
        g_strdup_printf("/tmp/llk_back%d.jpg", ui_pixbuf.randomback_choice - 1);
    if (ui_pixbuf.randomback)
      g_object_unref(ui_pixbuf.randomback); /* Free old randomback pixbuf */
    ui_pixbuf.randomback = gdk_pixbuf_new_from_file(bgfilename, NULL);
    remove(bgfilename);
  ...
  if (!ui_pixbuf.cardimages || !ui_pixbuf.cardbacks || !ui_pixbuf.vertical ||
      !ui_pixbuf.horizon || !ui_pixbuf.logo || !ui_pixbuf.pause ||
      !ui_pixbuf.mainback) {
...
void ui_use_m_s_bg(GtkWidget *w, gpointer data) {
  switch (GPOINTER_TO_INT(data)) {
  case 0:
    ini_file_write_boolean(
        ui_ini, "UISETTING", "bgmusic",
        gtk_check_menu_item_get_active(ui_menu_item.background_music));
    break;
  case 1:
    ini_file_write_boolean(
        ui_ini, "UISETTING", "sound",
        gtk_check_menu_item_get_active(ui_menu_item.sound_effect));
    break;
  case 2:
    ini_file_write_boolean(
        ui_ini, "UISETTING", "bgpicture",
        gtk_check_menu_item_get_active(ui_menu_item.background_picture));
    /* redraw all images */
    if (algorithm_game.status == ALGORITHM_GAME_RUN)
      ui_redraw_images();
    break;
...
void radio_item_on_clicked(GtkWidget *w, gpointer data) {
  ...
  if (!ini_file_read_string(ui_ini, "THEMEFILE", themenum, &return_str)) {
    ...
    path =
        g_strdup_printf("%s/%s/%s.pak", PACKAGE_DATA_DIR, PACKAGE, return_str);
    g_free(return_str);
    if (!g_file_test(path, G_FILE_TEST_EXISTS)) {
      ...
      if (!LoadPAKHFT(path)) {
        ...
        if (!ExtractSingleFile("cardimages.png") ||
            !ExtractSingleFile("cardbacks.png") ||
            !ExtractSingleFile("horizon.png") ||
            !ExtractSingleFile("vertical.png") ||
            !ExtractSingleFile("pause.jpg") || !ExtractSingleFile("logo.png") ||
            !ExtractSingleFile("mainback.jpg")) {
          ...
          ui_pixbuf.cardbacks =
              gdk_pixbuf_new_from_file("/tmp/llk_cardbacks.png", NULL);
          ui_pixbuf.vertical =
              gdk_pixbuf_new_from_file("/tmp/llk_vertical.png", NULL);
          ui_pixbuf.horizon =
              gdk_pixbuf_new_from_file("/tmp/llk_horizon.png", NULL);
          ui_pixbuf.logo = gdk_pixbuf_new_from_file("/tmp/llk_logo.png", NULL);
          ui_pixbuf.pause =
              gdk_pixbuf_new_from_file("/tmp/llk_pause.jpg", NULL);
          ui_pixbuf.mainback =
              gdk_pixbuf_new_from_file("/tmp/llk_mainback.jpg", NULL);
          // ui_pixbuf.cardback_choice = g_rand_int_range(ui_rand,0,6);
          /* Do not change card back choice when change theme*/
          if (pak_info.back_num > 0) {
            ui_pixbuf.randomback_choice =
                g_rand_int_range(ui_rand, 1, pak_info.back_num + 1);
            /* Extract the bg picture and read it to ui_pixbuf.randomback */
            ...
            if (ui_pixbuf.randomback)
              g_object_unref(
                  ui_pixbuf.randomback); /* Free old randomback pixbuf */
            ui_pixbuf.randomback = gdk_pixbuf_new_from_file(bgfilename, NULL);
            remove(bgfilename);
            g_free(bgfilename);
            if (ui_pixbuf.randomback == NULL) {
          ...
          remove("/tmp/llk_pause.jpg");
          remove("/tmp/llk_mainback.jpg");
          if (!ui_pixbuf.cardimages || !ui_pixbuf.cardbacks ||
              !ui_pixbuf.vertical || !ui_pixbuf.horizon || !ui_pixbuf.logo ||
  ...
  if (success) {
    ...
    if (!ini_file_write_file(
            ui_ini,
            ui_ini->filename)) { /* g_print("Ini file save error!\n"); */
    }
    ...
    /* ignore the error of convert png file,when other errors occored,because we
       have not change anything, so just reset the radio menu item's active
       status */
    called_from_menu = FALSE;
    gtk_check_menu_item_set_active(
        GTK_CHECK_MENU_ITEM(ui_menu_item.current_theme), TRUE);
...
void ui_record_score(gboolean view) {
  ...
  if (!view) /* If not just view the score,then this function must be called by
                ui_game_over,so add the current player's score into the list,and
                then write to file if the list is modified,and at last,show the
                score list on a new window */
  {
    gint insert_pos = 1;
    for (score_item_tmp = score_list; score_item_tmp != NULL;
         score_item_tmp = score_item_tmp->next) {
      if (algorithm_game.score > atoi(score_item_tmp->score))
        break;
      insert_pos++;
    }
    if (insert_pos > 10) {
      ...
      if (insert_pos == 1) {
        if (score_list == NULL) {
          ...
          score_item_tmp =
              (struct ScoreItem *)g_malloc(sizeof(struct ScoreItem));
          score_item_tmp->prev = NULL;
    ...
    switch (algorithm_game.difficulty) {
    case 0:
      sprintf(score_item_tmp->difficulty, _("Easy"));
      break;
    case 1:
      sprintf(score_item_tmp->difficulty, _("Normal"));
      break;
    case 2:
      sprintf(score_item_tmp->difficulty, _("Hard"));
      break;
    default:
      sprintf(score_item_tmp->difficulty, _("Unknown"));
      break;
    }
    ...
    if (insert_pos != 0) /* score_list has been changed,so save it to file */
    {
      ...
      g_free(path);
      return; /* If player's score is not within 10,no record it,and no show the
                 score window. */
    }
  }
  g_free(path);
  ...
  gtk_tree_view_insert_column_with_attributes(
      GTK_TREE_VIEW(tree_view), -1, _("Position"), renderer, "text", 0, NULL);
  /* --- Column #2 --- */
  renderer = gtk_cell_renderer_text_new();
  gtk_tree_view_insert_column_with_attributes(
      GTK_TREE_VIEW(tree_view), -1, _("Score"), renderer, "text", 1, NULL);
  /* --- Column #3 --- */
  renderer = gtk_cell_renderer_text_new();
  gtk_tree_view_insert_column_with_attributes(
      GTK_TREE_VIEW(tree_view), -1, _("Name"), renderer, "text", 2, NULL);
  /* --- Column #4 --- */
  renderer = gtk_cell_renderer_text_new();
  gtk_tree_view_insert_column_with_attributes(
      GTK_TREE_VIEW(tree_view), -1, _("Nick name"), renderer, "text", 3, NULL);
  /* --- Column #5 --- */
  renderer = gtk_cell_renderer_text_new();
  gtk_tree_view_insert_column_with_attributes(
      GTK_TREE_VIEW(tree_view), -1, _("Difficulty"), renderer, "text", 4, NULL);
  /* --- Column #6 --- */
  renderer = gtk_cell_renderer_text_new();
  gtk_tree_view_insert_column_with_attributes(
      GTK_TREE_VIEW(tree_view), -1, _("Level"), renderer, "text", 5, NULL);
  /* --- Column #7 --- */
  renderer = gtk_cell_renderer_text_new();
  gtk_tree_view_insert_column_with_attributes(
      GTK_TREE_VIEW(tree_view), -1, _("Data&Time"), renderer, "text", 6, NULL);
  /*-------------------*/
  store = gtk_list_store_new(7, G_TYPE_UINT, G_TYPE_STRING, G_TYPE_STRING,
  ...
  for (item_num = 0; item_num < 10; item_num++) {
    if (score_item_tmp) {
      ...
      gtk_list_store_set(store, &iter, 0, item_num + 1, 1,
                         score_item_tmp->score, 2, score_item_tmp->name, 3,
                         score_item_tmp->nick, 4, score_item_tmp->difficulty, 5,
                         score_item_tmp->level, 6, score_item_tmp->time, -1);
      score_item_tmp = score_item_tmp->next;
    } else {
      /* Append a row and fill in some data */
      gtk_list_store_append(store, &iter);
      gtk_list_store_set(store, &iter, 0, item_num + 1, 1, "", 2, "", 3, "", 4,
                         "", 5, "", 6, "", -1);
    }
  }
  ...
  gtk_box_pack_start(GTK_BOX(GTK_DIALOG(dialog)->vbox), tree_view, FALSE, TRUE,
                     5);
  /* Create button */
  ...
  gtk_signal_connect_object(GTK_OBJECT(button), "clicked",
                            ...
                            GTK_OBJECT(dialog));
  gtk_box_pack_start(GTK_BOX(GTK_DIALOG(dialog)->action_area), button, FALSE,
                     FALSE, 0);
  gtk_widget_show_all(dialog);
}

void ui_view_score(GtkWidget *w, gpointer data) { ui_record_score(TRUE); }
void ui_theme_editor(GtkWidget *w, gpointer data) { create_pak_dialog(); }
/* tray popup menu call back function */
static void tray_popup_activate_action(GtkAction *action) {
...
int main(int argc, char *argv[]) {
  ...
  static GtkActionEntry tray_popup_entries[] = {
      ...
      {"Help", GTK_STOCK_HELP, N_("_Help"), NULL, N_("Help"),
       G_CALLBACK(ui_rule)},
  ...
  message =
      g_strdup_printf("%s%s%s", _("Lian Lian Kan "), VERSION, _(" by Alpher"));
  ...
  if (!gtk_ui_manager_add_ui_from_string(tray->ui, tray_popup_ui_info, -1,
                                         &tray_error)) {
  ...
  /*the first parameter FALSE,indicate the the main menu will no fullfill the
    main_vbox, the last parameter 0,is the spacing value of the main menu and
    the top of main_vbox*/
  gtk_box_pack_start(GTK_BOX(vbox), menubar, FALSE, TRUE, 0);
  gtk_widget_show(menubar);
  /*connect /functions/hide menuitem's event to hide window process*/
  g_signal_connect(
      G_OBJECT(g_list_nth_data(
          GTK_MENU(gtk_menu_item_get_submenu(GTK_MENU_ITEM(g_list_nth_data(
                       GTK_MENU_BAR(menubar)->menu_shell.children, 1))))
              ->menu_shell.children,
          4)),
  ...
  gtk_label_set_justify(GTK_LABEL(ui_top.label_change_type),
                        GTK_JUSTIFY_CENTER);
  ...
  gtk_widget_set_events(
      ui_drawingarea, GDK_EXPOSURE_MASK | GDK_LEAVE_NOTIFY_MASK |
  ...
  if (algorithm_game.status != ALGORITHM_GAME_STOP && !ui_save_game_data()) {
    g_print(_("Save game data to file error.\n"));
  }
  return FALSE;
}
